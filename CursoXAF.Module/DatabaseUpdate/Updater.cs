...
using CursoXAF.Module.BusinessObjects;
using System.Collections.Generic;

namespace CursoXAF.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            Pais paisACrear = ObjectSpace.FirstOrDefault<Pais>(u => u.Nombre == "México");
            if (paisACrear == null)
            {
                paisACrear = ObjectSpace.CreateObject<Pais>();
                paisACrear.Nombre = "México";
                paisACrear.Visible = true;
                paisACrear.FechaCreacion = DateTime.Now;
                paisACrear.Save();
            }

            Pais paisUSA = ObjectSpace.FirstOrDefault<Pais>(u => u.Nombre == "USA");
            if (paisUSA == null)
            {
                paisUSA = ObjectSpace.CreateObject<Pais>();
                paisUSA.Nombre = "USA";
                paisUSA.Visible = false;
                paisUSA.FechaCreacion = DateTime.Now;
                paisUSA.Save();
            }
